    ...
    <div className="container mx-auto px-4 py-8 space-y-8 max-w-5xl">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 space-y-3">
          ...
          <h3 className="text-lg font-bold text-gray-700">No blog posts available yet</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {articles.map((art) => {
            ...
            return (
              <Card
                key={art._id || art.id}
                className="rounded-2xl border shadow-sm overflow-hidden hover:shadow-md transition flex flex-col justify-between"
              >
                ...
                <CardContent className="p-5 space-y-3 flex-1 flex flex-col justify-between">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <Badge
                        variant="outline"
                        className="text-[10px] font-bold text-orange-600 border-orange-200 uppercase"
                      >
                  ...
                  <div className="pt-3 border-t flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1 text-xs text-orange-600 font-bold hover:underline cursor-pointer">
